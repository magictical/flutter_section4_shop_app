...
// SingleTickerProviderStateMixin? - provides props and method for animation
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        // Sign user up
        // only dispatch the signUp, So listen: false
        await Provider.of<Auth>(context, listen: false).signUp(
          _authData['email'],
          _authData['password'],
        );
      }
      // handling only httpException
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      // use AnimationContainer instead of Animatedbuilder
      // It doesn't need the controller above in the initState()
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                AnimatedContainer(
                  // manage input box size by BoxContraints.
                  //
